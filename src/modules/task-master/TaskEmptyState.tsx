    ...
    return (
      <div className={cn('text-center py-12', className)}>
        <div className="mx-auto max-w-md">
          ...
          <h3 className="mb-2 text-lg font-semibold text-foreground dark:text-foreground">{t('notConfigured.title')}</h3>
          <p className="mb-6 text-sm text-muted-foreground dark:text-muted-foreground">{t('notConfigured.description')}</p>

          <div className="mb-6 rounded-lg bg-accent p-4 text-left dark:bg-accent">
          ...
          <button
            ...
            className="mx-auto flex items-center gap-2 rounded-lg bg-primary px-4 py-2 font-medium text-primary-foreground transition-colors hover:bg-primary"
          >
  ...
  return (
    <div className={cn('text-center py-12', className)}>
      <div className="mx-auto max-w-4xl">
        <div className="mb-6 rounded-xl border border-border p-6 text-left dark:border-border">
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-foreground dark:text-foreground">{t('gettingStarted.title')}</h2>
              <p className="text-sm text-muted-foreground dark:text-muted-foreground">{t('gettingStarted.subtitle')}</p>
            </div>
          </div>

          <div className="mb-4 space-y-3">
            <div className="rounded-lg border border-border bg-background p-3 dark:border-border/50 dark:bg-secondary/60">
              <h4 className="mb-1 font-medium text-foreground dark:text-foreground">1. {t('gettingStarted.steps.createPRD.title')}</h4>
              <p className="mb-3 text-sm text-muted-foreground dark:text-muted-foreground">{t('gettingStarted.steps.createPRD.description')}</p>

              <button
                onClick={onCreatePrd}
                className="inline-flex items-center gap-2 rounded bg-accent px-2 py-1 text-xs text-muted-foreground hover:bg-accent dark:bg-accent/30 dark:text-muted-foreground dark:hover:bg-accent/50"
              >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {existingPrds.map((prd) => (
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded bg-secondary px-2 py-1 text-xs text-foreground hover:bg-accent dark:bg-accent dark:text-muted-foreground dark:hover:bg-accent"
                      >
                        <FileText className="h-3 w-3" />
                        {prd.name}
                      </button>
            ...
            <div className="rounded-lg border border-border bg-background p-3 dark:border-border/50 dark:bg-secondary/60">
              <h4 className="mb-1 font-medium text-foreground dark:text-foreground">2. {t('gettingStarted.steps.generateTasks.title')}</h4>
              <p className="text-sm text-muted-foreground dark:text-muted-foreground">{t('gettingStarted.steps.generateTasks.description')}</p>
            </div>

            <div className="rounded-lg border border-border bg-background p-3 dark:border-border/50 dark:bg-secondary/60">
              <h4 className="mb-1 font-medium text-foreground dark:text-foreground">3. {t('gettingStarted.steps.analyzeTasks.title')}</h4>
              <p className="text-sm text-muted-foreground dark:text-muted-foreground">{t('gettingStarted.steps.analyzeTasks.description')}</p>
            </div>

            <div className="rounded-lg border border-border bg-background p-3 dark:border-border/50 dark:bg-secondary/60">
              <h4 className="mb-1 font-medium text-foreground dark:text-foreground">4. {t('gettingStarted.steps.startBuilding.title')}</h4>
          ...
          <button
            onClick={onCreatePrd}
            className="inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 font-medium text-primary-foreground hover:bg-primary"
          >
