...
export default function WorkspaceHeader({
  ...
  return (
    <header data-codex-workspace-header className="pwa-header-safe flex-shrink-0 border-b border-border/60 bg-background/95 px-3 py-1.5 backdrop-blur-sm sm:px-4 sm:py-2">
