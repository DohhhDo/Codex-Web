...
export default function Onboarding({ onComplete }: OnboardingProps) {
  ...
  return (
    <>
      <div className="codex-onboarding relative overflow-y-auto bg-background">
              ...
              <div className="flex items-center gap-3">
                {currentStep < 1 ? (
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl bg-primary px-6 py-2.5 font-medium text-primary-foreground shadow-none transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-60 disabled:shadow-none"
                  >
                    {isSubmitting ? (
                      <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl bg-emerald-600 px-6 py-2.5 font-medium text-white shadow-none transition-all duration-200 hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-60 disabled:shadow-none"
                  >
                    {isSubmitting ? (
                      <>
                        <Loader2 className="h-4 w-4 animate-spin" />
