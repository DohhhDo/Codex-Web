...
export default function Shell({
  ...
  if (minimal) {
    return (
      <div className="codex-terminal flex h-full min-h-0 flex-col bg-background">
    ...
    <div className="codex-terminal flex h-full min-h-0 w-full min-w-0 flex-col bg-background">
      ...
      <div className="codex-terminal-body relative min-h-0 flex-1 overflow-hidden px-4 py-5 sm:px-6 sm:py-6">
        ...
        {cliPromptOptions && isConnected && (
          <div
            className="shrink-0 border-t border-border bg-background px-3 py-2 md:hidden"
            ...
            <div className="flex flex-wrap items-center gap-2">
              {cliPromptOptions.map((opt) => (
                <button
                  ...
                  className="max-w-36 truncate rounded bg-primary px-3 py-1.5 text-xs font-medium text-primary-foreground transition-colors hover:brightness-95"
