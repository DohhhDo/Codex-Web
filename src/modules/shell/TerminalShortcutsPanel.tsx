...
import { ClipboardIcon as Clipboard } from '@phosphor-icons/react/dist/csr/Clipboard';
...
const KEY_BTN =
  'shrink-0 rounded-md border border-border bg-muted px-2.5 py-1.5 text-xs font-medium text-foreground transition-colors select-none active:bg-accent active:text-foreground active:border-border disabled:cursor-not-allowed disabled:opacity-40';
...
const ICON_BTN =
  'shrink-0 rounded-md border border-border bg-muted p-1.5 text-foreground transition-colors select-none active:bg-accent active:text-foreground active:border-border disabled:cursor-not-allowed disabled:opacity-40';
...
export default function TerminalShortcutsPanel({
  ...
  return (
    <div className="codex-terminal-shortcuts min-w-0 shrink-0 border-t border-border bg-background px-2 pb-safe-area-inset-bottom md:hidden">
      <div className="flex items-center gap-1 overflow-x-auto px-1.5 py-1.5 [-webkit-overflow-scrolling:touch] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <button
          type="button"
