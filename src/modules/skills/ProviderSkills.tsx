...
import { FolderSimpleIcon as FolderUp } from '@phosphor-icons/react/dist/csr/FolderSimple';
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-3 py-4 text-center">
          <FileUp className="h-7 w-7 text-muted-foreground" weight="duotone" />
    ...
    <div className="min-w-0 space-y-4 overflow-x-hidden">
      <div className="flex min-w-0 items-start gap-3">
        <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-border/70 bg-muted/20 text-muted-foreground">
          <FileCode2 className="h-4 w-4" weight="regular" />
        </div>
