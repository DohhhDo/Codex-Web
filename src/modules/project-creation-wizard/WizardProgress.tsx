                ...
                className={`flex h-8 w-8 items-center justify-center rounded-full text-sm font-medium ${
                  currentStep < step
                    ...
                    : currentStep === step
                      ...
                      : 'bg-accent text-muted-foreground dark:bg-accent'
                }`}
              >
                {currentStep < step ? <Check className="h-4 w-4" /> : currentStep}
              </div>
              <span className="hidden text-sm font-medium text-foreground dark:text-muted-foreground sm:inline">
                {currentStep === 1
            ...
            {currentStep < 2 && (
              <div
                className={`mx-2 h-1 flex-1 rounded ${
                  currentStep < step ? 'bg-green-500' : 'bg-accent dark:bg-accent'
                }`}
              />
            )}
          </Fragment>
