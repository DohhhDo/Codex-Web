...
import { HandIcon as Hand } from '@phosphor-icons/react/dist/csr/Hand';
import { ShieldWarningIcon as ShieldQuestion } from '@phosphor-icons/react/dist/csr/ShieldWarning';
import { SmileyIcon as Smile } from '@phosphor-icons/react/dist/csr/Smiley';
...
function ComposerPermissionMenu({
  ...
  // Keep the approval picker open while the user reviews available modes.
  ...
  return (
    <>
      <button
        ...
        className={`codex-composer-permission ${permissionMode === 'default' ? 'text-muted-foreground' : activeAppearance.item}`}
        aria-haspopup="menu"
      ...
      >
        ...
        <span className="truncate">{t(`codex.modes.${permissionMode}`, { defaultValue: permissionMode })}</span>
      </button>
