...
import { ArrowElbowDownLeftIcon as CornerDownLeft } from '@phosphor-icons/react/dist/csr/ArrowElbowDownLeft';
...
const namespaceIcons: Record<string, IconComponent> = {
  frequent: Star,
  builtin: Terminal,
  skill: Sparkles,
  project: Folder,
            ...
            return (
              ...
              >
                ...
                <span className={`mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-md border ${accentClass}`}>
                  <NamespaceIcon aria-hidden="true" size={14} weight="regular" />
                </span>
                ...
                {isSelected && (
                  <span className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded border border-primary/30 bg-card text-primary shadow-sm">
                    <CornerDownLeft aria-hidden="true" size={13} weight="regular" />
                  </span>
                )}
              </div>
            );
