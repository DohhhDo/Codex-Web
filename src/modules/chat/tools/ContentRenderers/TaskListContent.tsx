...
const statusConfig = {
  completed: {
    icon: (
      <CheckCircleIcon className="h-3.5 w-3.5 text-green-500 dark:text-green-400" aria-hidden />
    ),
  ...
  in_progress: {
    icon: (
      <ClockIcon className="h-3.5 w-3.5 text-blue-500 dark:text-blue-400" aria-hidden />
    ),
  ...
  pending: {
    icon: (
      <CircleIcon className="h-3.5 w-3.5 text-gray-400 dark:text-gray-500" aria-hidden />
    ),
