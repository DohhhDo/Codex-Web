  ...
  return (
    <div className="group relative">
      ...
      <div>
        <div
          className={cn(
            'codex-session-row p-2 my-0.5 rounded-md border border-transparent transition-colors relative',
            isSelected ? 'codex-session-selected' : '',
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                ...
                {isProcessing ? (
                  ...
                  <span className="sr-only">{compactSessionAge}</span>
                )}
              </div>
          ...
          >
            ...
            <div className="mb-4 flex items-center gap-3 px-1">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 break-all text-xs text-muted-foreground">{project.fullPath}</p>
                <p className="mt-1 text-xs text-muted-foreground">{compactSessionAge}</p>
              </div>
            </div>
      ...
      <div>
        <a
          ...
          className={cn(
            ...
            'codex-session-row h-auto w-full justify-start rounded-md border border-transparent bg-transparent p-2 pr-8 text-left font-normal transition-colors duration-150',
            isSelected ? 'codex-session-selected bg-accent' : 'border-transparent',
            !isSelected && isProcessing
        ...
        <SessionOptions
          ...
          details={<><p className="break-all">{project.fullPath}</p><p>{compactSessionAge}</p></>}
