...
export default function SidebarProjectSessions({
  ...
  return (
    <div className="mb-2 ml-3 space-y-1 border-l border-border/60 pl-2">
      {isCompact ? (
        <div className="pb-1 pt-1">
          <button
            className="flex h-8 w-full items-center justify-start gap-2 rounded-md px-2 text-xs font-normal text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
            onClick={() => {
        ...
        <Button
          variant="ghost"
          size="sm"
          className="flex h-8 w-full justify-start gap-2 px-2 text-xs font-normal text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
