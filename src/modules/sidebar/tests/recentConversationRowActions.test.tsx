...
test('a running session keeps its indicator while dates move into menu details', () => {
  ...
  assert.ok(recordedOptionsProps[0].details);
  assert.ok(recordedOptionsProps[1].details);
});
