...
type SessionOptionsProps = {
  ...
  canDelete?: boolean;
  /** Secondary row metadata, available in the menu for pointer and touch users. */
  details?: ReactNode;
  className?: string;
  t: TFunction;
};
        ...
        <ActionMenu
          ...
          header={(
            <div className="mb-1 border-b border-border px-3 py-2">
              ...
              {details && <div className="mt-1 space-y-1 text-xs text-muted-foreground">{details}</div>}
            </div>
          )}
          items={[
            ...(projectId !== null ? [{
