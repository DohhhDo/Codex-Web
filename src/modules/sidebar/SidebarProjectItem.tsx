    ...
    <div className={cn('md:space-y-1', isDeleting && 'opacity-50 pointer-events-none')}>
      <div className="md:group group">
        ...
        <div>
          <div
            className={cn(
              'codex-project-mobile p-2 my-1 rounded-lg hover:bg-accent transition-colors',
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex min-w-0 flex-1 items-center gap-2">
                <button
                  className={cn(
                    'w-8 h-8 shrink-0 rounded-md flex items-center justify-center transition-colors hover:bg-accent',
                    isStarred
                      ? 'text-yellow-600'
                ...
                <div className="min-w-0 flex-1">
                  {isEditing ? (
                    ...
                    <>
                      ...
                      <p className="sr-only">{sessionCountLabel}</p>
                    </>
                  )}
                </div>
              </div>
        ...
        <Button
          variant="ghost"
          className={cn(
            'codex-project-row flex w-full justify-between p-2 pr-7 h-auto font-normal hover:bg-accent/50',
          ...
          title={`${project.displayName}\n${project.fullPath} · ${sessionCountLabel}`}
        >
          <div className="flex min-w-0 flex-1 items-center gap-2">
            <div
              className={cn(
          ...
          <div className="codex-project-actions flex flex-shrink-0 items-center gap-1">
            {isEditing ? (
              <>
                <div
              ...
              <>
                <div
                  className="codex-project-edit touch:opacity-100 flex h-6 w-6 cursor-pointer items-center justify-center rounded opacity-0 transition-all duration-200 hover:bg-accent group-hover:opacity-100"
                  onClick={(event) => {
                    event.stopPropagation();
                    onStartEditingProject(project);
                  }}
                ...
                <div
                  className="codex-project-edit touch:opacity-100 flex h-6 w-6 cursor-pointer items-center justify-center rounded opacity-0 transition-all duration-200 hover:bg-red-50 group-hover:opacity-100 dark:hover:bg-red-900/20"
                  onClick={(event) => {
                    event.stopPropagation();
                    onDeleteProject(project);
                  }}
