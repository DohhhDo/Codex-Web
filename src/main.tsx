...
if ('serviceWorker' in navigator && document.documentElement.dataset.demo !== 'true') {
...
ReactDOM.createRoot(rootElement).render(
  <React.StrictMode>
    <IconContext.Provider value={{ size: 20, weight: 'regular', 'aria-hidden': true, focusable: false }}>
      <App />
