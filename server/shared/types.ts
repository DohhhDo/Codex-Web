...
/** Non-secret Codex usage metadata forwarded to the composer. Cached tokens are
 * a subset of input tokens. Limits describe account windows, never context size. */
